...
best_error = run_experiment(OUTPUT_FOLDER,source, target, source_normals, target_normals, sampling, selection, matching, rejection, weighting, false,truth_translate, truth_angles);
...
for i=2:length(matchings)
    ...
    new_error = run_experiment(OUTPUT_FOLDER,source, target, source_normals, target_normals, sampling, selection, new_matching, rejection, weighting, false,truth_translate, truth_angles);
